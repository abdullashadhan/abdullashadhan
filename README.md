...
class AbdullaShadhan:
    ...
    name     = "Abdulla Shadhan S"
    location = "Bangalore, India"
    degree   = "BCA, Computer Science (AI · ML · Robotics)"
    role     = "Data Analyst Intern @ WAHY Lab Solutions"
...
<div align="center">
  <img src="https://streak-stats.demolab.com?user=abdullashadhan&theme=tokyonight-duo&hide_border=true&background=0D1117&ring=58A6FF&fire=A78BFA&currStreakLabel=58A6FF&sideLabels=7DD3FC&dates=8B949E&currStreakNum=E6EDF3&sideNums=E6EDF3&stroke=0D1117&border_radius=10" />
</div>
...
<div align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=abdullashadhan&theme=tokyonight&no-frame=true&no-bg=true&row=1&column=7&margin-w=4" />
</div>
...
| | Achievement | Details |
|:-:|:--|:--|
| 🏅 | Microsoft Power BI Data Analyst | Certified by Microsoft in data modeling, visualization, and DAX |
| 🧠 | IBM Introduction to Artificial Intelligence | Foundational AI concepts, ML pipelines, and neural networks |
| 🤝 | IBM People & Soft Skills | Essential for Professional Success program |
| 📊 | 40% Efficiency Improvement | Automated reporting at WAHY Lab Solutions using SQL and Python |
| 🌍 | Multilingual (4 languages) | Hindi C2 · Malayalam C2 · English C1 · Tamil B1 |
...
Backend Foundations     → python, java, sql, git
```
